---
name: book-rag
description: 从免费开放的书本 RAG 书库中检索原文。当用户询问书里的内容、要求引用书中原文、或问题涉及圣经注释、研经资料、教育、文集类书籍时使用本技能。书库含 81 个知识库、211 篇文档。
---
...
知识库数量较多（81 个），如果用户明确提到书名就直接按名字匹配；如果只给了主题，选名字最贴近的几个分别检索。
